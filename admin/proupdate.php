...
?>
      ...
      <input type="text" class="form-control" id="name" placeholder="Enter Product Name"  value="<?php echo $final['name'] ?>" name="name">
                ...
                <div class="form-group">
                 ...
                 <div class="form-group">
                  <label for="picture">File input 2 [PRODUCT DETAIL THUMBNAIL]</label>
                <input type="file" id="picture2" name="file2"  value="<?php echo $final['picture2'] ?>">
                </div>
                 <div class="form-group">
                  <label for="picture">File input 3 [PRODUCT DETAIL THUMBNAIL]</label>
                  <input type="file" id="picture3" name="file3" value="<?php echo $final['picture3'] ?>">
                </div>
                <div class="form-group">
