            ...
            <div class="col-lg-10 col-xl-7 m-lr-auto m-b-50">
                ...
                <div class="col-sm-10 col-lg-7 col-xl-5 m-lr-auto m-b-50">
                    <div class="bor10 p-lr-40 p-t-30 p-b-40 m-l-63 m-r-40 m-lr-0-xl p-lr-15-sm">
                            ...
                            <div class="size-209 p-r-18 p-r-0-sm w-full-ssm">
                                ...
                                <div class="p-t-15">
                                    ...
                                    <div class="bor8 bg0 m-b-12">
                                        <input class="stext-111 cl8 plh3 size-111 p-lr-15" type="text" placeholder="Address, city, Town" name="address">
                                    </div>
                                    ...
                                    <div class="bor8 bg0 m-b-22">
                                        ...
                                        N/B:WE Will call to Confirm If you Choose To pay Upon Delivery
                                </div>
                            </div>
                        </div>
                        ...
                        <button class="flex-c-m stext-101 cl0 size-116 bg3 bor14 hov-btn3 p-lr-15 trans-04 pointer" name="order" type="submit" name="placeholder">
                            Place Order
                        </button>
                    </form>
                    </div>
