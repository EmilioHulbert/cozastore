...
?>
	...
	<!-- Product -->
	<section class="bg0 p-t-23 p-b-140" style="background-color:antiquewhite;">
		<div class="container">
			<div class="p-b-10">
			...
			<div class="flex-w flex-sb-m p-b-52">
				<div class="flex-w flex-l-m filter-tope-group m-tb-10">
					...
					<a href="secondhandshoes.php">
					<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" >
					SECOND HAND SHOES
					</button>
					</a>
					<a href="customshoes.php">
					<button class="stext-106 cl6 hov1 bor3 trans-04 m-r-32 m-tb-5" >
					CUSTOM SHOES & USED SHOES
					</button>
					</a>
				</div>
				...
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item <?php echo $final['category_id']?>">
					...
					<div class="block2">
						<div class="block2-pic hov-img0">
							<img src="<?php echo $final['picture']?>" alt="IMG-PRODUCT" style="min-height: 250px;max-height: 250px">
